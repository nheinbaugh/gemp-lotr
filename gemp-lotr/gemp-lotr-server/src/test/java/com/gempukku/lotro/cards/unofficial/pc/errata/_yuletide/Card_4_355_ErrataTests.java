...
public class Card_4_355_ErrataTests
{
	...
	public void CavernEntranceStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		*/
		...
		//assertEquals(Race.STANDARD, card.getBlueprint().getRace());
		//assertTrue(card.getBlueprint().getPossessionClasses().contains(PossessionClass.STANDARD));
		...
		assertEquals(7, card.getBlueprint().getSiteNumber());		assertEquals(SitesBlock.TWO_TOWERS, card.getBlueprint().getSiteBlock());
	}
