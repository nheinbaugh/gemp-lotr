...
public class Card_2_076_ErrataTests
{
	...
	public void HelplessStatsAndKeywordsAreCorrect() throws DecisionResultInvalidException, CardNotFoundException {
		...
		* Game Text: Bearer's game text does not apply (except keywords).
		* 	Maneuver: Exert a Nazgul to transfer this to a Ring-bound companion.
